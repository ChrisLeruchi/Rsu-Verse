...
router.post('/:id/downvote', protect, postController.toggleDownvote);


router.post('/:id/comments', protect, postController.addComment);
router.post('/:id/comments/:commentId/upvote', protect, postController.toggleCommentUpvote);
router.post('/:id/comments/:commentId/downvote', protect, postController.toggleCommentDownvote);
router.post('/:id/comments/:commentId/replies', protect, postController.addCommentReply);
router.post('/:id/save', protect, postController.toggleSavePost);
router.post('/:id/share', protect, postController.incrementShare);
