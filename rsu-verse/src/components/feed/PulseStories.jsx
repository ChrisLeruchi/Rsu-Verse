      ...
      <div className="flex items-center gap-4 py-4 px-6 overflow-x-auto no-scrollbar border-b border-white/5 bg-void/50">
        {stories.map((story) => (
          <button
            ...
            <div className={`w-18 h-18 rounded-full p-[2px] transition-transform duration-300 group-active:scale-95 ${
              story.active
            ...
            <span className="text-[14px] font-medium tracking-wide text-white/50 group-hover:text-white/80 transition-colors">
              {story.location}
            </span>
          </button>
        ))}
